<template>
    <div class="bg-brand text-white shadow-md" style="padding-top: 5rem">
        <div class="container mx-auto nav-bar">
            <h1 class="font-medium mb-4 px-4 md:px-0">QR Dynamics</h1>
